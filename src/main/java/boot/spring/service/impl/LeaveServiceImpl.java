...
public class LeaveServiceImpl implements LeaveService {
    ...
    @Override
    public LeaveApply getSelfById(int id) {
        return getLeave(id);
    }

    @Override
    public List<LeaveTask> getPageTasksByGroup(String group, int firstRow, int rowCount) {
        List<LeaveTask> results = new ArrayList<>();
